        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
            ...
            <main className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
                    ...
                    <span className="text-gray-900 dark:text-white font-medium">{decodedKey}</span>
                </div>
                ...
                <div className={`flex items-center gap-4 mb-8 pb-4 border-b ${colors.header}`}>
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{decodedKey}</h1>
                ...
                {loading ? (
                    ...
                    <div className="rounded-2xl border border-black/5 dark:border-white/5 bg-white/[0.02] py-16 text-center">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">No notices in this category.</p>
                        <Link
                            to="/dashboard"
